    ...
    <section className="hero">
      ...
      <div className="hero-content container">
        ...
        <h1 className="heading-xl hero-title">
          Centralize seus atendimentos<br /> Acelere respostas<br /> <span className="highlight">Venda mais.</span>
        </h1>
        ...
        <div className="hero-actions">
          <a href="#features" className="btn btn-primary btn-lg">Funcionalidades <FiArrowDown size={22} /></a>
        </div>
      </div>
    </section>
  );
